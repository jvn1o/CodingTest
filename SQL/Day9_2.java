/*
    ...
    REPLY_ID, BOARD_ID, WRITER_ID, CONTENTS, CREATED_DATE 는 각각
...
/*
    ...
    AND USED_GOODS_REPLY R
    WHERE EXTRACT(YEAR FROM R.CREATED_DATE) = 2022
    AND EXTRACT(MONTH FROM R.CREATED_DATE) = 10
